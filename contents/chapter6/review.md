...
### 트랜잭션 정의
DefaultTrnasactionDefinition이 구현하고 있는 TrnasactionDefinition 인터페이스는 트랜잭션의 동작방식에 영향을 줄 수 있는 네 가지 속성을 정의하고 있다.
...
* PROPAGATION_REQUIRES_NEW: 항상 새로운 트랜잭션을 시작한다. 독자적으로 동작한다.
* PROPAGATION_NOT_SUPPORTED: 트랜잭션 없이 동작하도록 만들 수 있다.
...
* 트랜잭션을 직접 시작할 수 있는 PROPAGATION_REQUIRED나 PROPAGATION_REQUIRES_NEW와 함께 사용해야만 의미가 있다.
...
* tx 네임스페이스를 통해 트랜잭션 속성 지정이 가능하다.
